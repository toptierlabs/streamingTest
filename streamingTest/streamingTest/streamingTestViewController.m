...
{
	if ([streamer isWaiting] && streamer.state != AS_STOPPING)
	{
		[self setButtonImage:[UIImage imageNamed:@"loadingbutton.png"]];
	}
...
- (void)viewDidLoad
{
	...
	NSString *pathConfig = [[NSBundle mainBundle] pathForResource:@"StreamConfig" ofType:@"plist"];
    NSDictionary *dicConfig = [[NSDictionary alloc] initWithContentsOfFile:pathConfig];
    streamPath = [dicConfig objectForKey:@"StreamPath"];
